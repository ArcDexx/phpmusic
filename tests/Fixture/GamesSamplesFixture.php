 ...
 *
 */
class GamesSamplesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'games_samples_Game' => ['type' => 'index', 'columns' => ['game_id'], 'length' => []],
            'games_samples_Samples' => ['type' => 'index', 'columns' => ['sample_id'], 'length' => []],
        ],
        '_constraints' => [
